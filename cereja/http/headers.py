...
class Headers:
    ...
    def add(self, name, value): self._items.append(self._validate(name, value))
    ...
    def __getitem__(self, name):
        ...
        return value
    def __contains__(self, name): return bool(self.get_list(name))
    def __iter__(self) -> Iterator[tuple[str, str]]: return iter(self._items)
    def __len__(self): return len(self._items)
    def items(self): return list(self._items)
    def copy(self): return Headers(self._items)
    def __repr__(self): return f"Headers({self._items!r})"
